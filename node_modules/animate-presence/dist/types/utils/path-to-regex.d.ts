 ...
 */
export declare const parse: (str: string, options?: ParseOptions) => Token[];
/**
 * Compile a string to a template function for the path.
 */
export declare const compile: (str: string, options?: ParseOptions) => PathFunction;
/**
 ...
 */
export declare const tokensToRegExp: (tokens: Token[], keys?: Key[], options?: RegExpOptions) => RegExp;
/**
