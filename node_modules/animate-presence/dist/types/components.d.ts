...
declare global {
  ...
  interface HTMLAnimatePresenceElement extends Components.AnimatePresence, HTMLStencilElement {}
  var HTMLAnimatePresenceElement: {
    prototype: HTMLAnimatePresenceElement;
    new (): HTMLAnimatePresenceElement;
  };

  interface HTMLAnimatedRouteSwitchElement extends Components.AnimatedRouteSwitch, HTMLStencilElement {}
...
declare module "@stencil/core" {
  export namespace JSX {
    interface IntrinsicElements {
      'animate-presence': LocalJSX.AnimatePresence & JSXBase.HTMLAttributes<HTMLAnimatePresenceElement>;
      'animated-route-switch': LocalJSX.AnimatedRouteSwitch & JSXBase.HTMLAttributes<HTMLAnimatedRouteSwitchElement>;
    }
  }
}
